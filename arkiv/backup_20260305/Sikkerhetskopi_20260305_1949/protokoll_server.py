...
# -*- coding: utf-8 -*-
"""
Protokoll Server - Kommunikasjon med Acer Monitor
Kjører på Lenovo (100.108.91.44) port 8765
"""
    ...
    async def process_message(self, websocket, message):
        ...
        try:
            ...
            if msg_type == "start_protokoll":
                ...
                # Bruker på Acer har godkjent/avvist fiks
...
║                                                           ║
║  Acer kan koble til med:                                  ║
║  ws://100.108.91.44:{self.port}                             ║
╚═══════════════════════════════════════════════════════════╝
        """)
